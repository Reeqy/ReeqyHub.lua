...
local function JZKG_fake_script() -- Dots.Dots 
...
coroutine.wrap(JZKG_fake_script)()
local function QHMIFLX_fake_script() -- MainFrame.Manager 
...
coroutine.wrap(QHMIFLX_fake_script)()
local function UKAN_fake_script() -- Percentage.Percentage 
...
coroutine.wrap(UKAN_fake_script)()
local function KUXLJU_fake_script() -- Tip.Tips 
	...
	while true do
		wait(5)
		tip.Text = "Wanna win a synapse key? Dm Reeqy#9499 FREESYNAPSEKEYPLS105 "
		wait(5)
		tip.Text = "https://discord.gg/s9C9dWhAqV"
		wait(5)
		tip.Text = "Get the key in the discord!"
	end
end
coroutine.wrap(KUXLJU_fake_script)()
local function OKGG_fake_script() -- Loading.DefaultUI 
...
coroutine.wrap(OKGG_fake_script)()